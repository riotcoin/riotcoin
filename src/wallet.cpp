...
// riotcoin: total coins staked (non-spendable until maturity)
...
// riotcoin: check 'spent' consistency between wallet and txindex
// riotcoin: fix wallet spent state according to txindex
...
// riotcoin: disable transaction (only for coinstake)
